...
argument-hint: [optional: path/to/plan.md] [optional: rounds:N] [optional: effort:low|medium|high|xhigh] [optional: model:gpt-5.4|gpt-5.3-codex|gpt-5.4-mini|gpt-5.3-codex-spark]
